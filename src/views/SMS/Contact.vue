<template>
  <div class="relative overflow-hidden pt-6" style="
      ...
      <div class="grid grid-cols-1 gap-x-16 gap-y-8 lg:grid-cols-5">
        <div class="lg:col-span-2 lg:py-12">
          <div class="py-6 md:py-0 md:px-6">
            <h1 class="text-4xl font-bold"> <span class="border-b-4 border-purple-500 cursor-pointer">Demo?</span></h1>
            <p class="pt-2 pb-4">To request a demo, simply fill out the form below and we'll be in touch shortly.</p>
          </div>
        </div>
          ...
          <form @submit.prevent="submitForm" class="space-y-4">
            <div>
              ...
              <input
                  ...
                  class="w-full rounded-lg border border-purple-200 !outline-none p-3 text-sm"
                  placeholder="Name"
                  type="text"
                  id="name"
              />
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div>
                ...
                <input
                    ...
                    class="w-full border border-purple-200 !outline-none rounded-lg p-3 text-sm"
              ...
              <div>
                ...
                <input
                    ...
                    class="border border-purple-200 !outline-none w-full rounded-lg p-3 text-sm"
            ...
            <div class="mt-4">
              <button
                  type="submit"
                  class="shadow-md font-medium my-5 py-2 px-4 text-white cursor-pointer bg-purple-500 hover:bg-purple-600 rounded text-lg text-center w-32"
              >
                Send
              </button>
            </div>
    ...
    <div class="relative">
      <div v-if="showNotification" class="bg-white/20  backdrop-blur-xl z-20 max-w-md absolute right-5 bottom-1 rounded-lg p-3 shadow-lg">
        <button @click="showNotification = !showNotification" type="button" class="absolute top-0 right-1.5 text-purple-600 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-hide="authentication-modal">
